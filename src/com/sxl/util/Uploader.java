...
public class Uploader {
	 ...
	 * @return 
	 */
	public Boolean isDirExist(FTPClient ftpClient, String ftpDir) {
		SimpleDateFormat formater = new SimpleDateFormat("yyyyMMdd");
		ftpDir = ftpDir+formater.format(new Date());
		
		try {
			int retCode =  ftpClient.cwd(ftpDir);
	  ...
	  * @throws IOException
	  */
	 public String createDir(FTPClient ftpClient, String ftpDir) throws IOException{
		 SimpleDateFormat formater = new SimpleDateFormat("yyyyMMdd");
		 ftpDir = ftpDir+formater.format(new Date());
		 
		  if(!isDirExist(ftpClient, ftpDir)){
